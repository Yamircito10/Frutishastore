...
async function ajustarStock(prendaId, tallaNumero, delta) {
  return db.runTransaction(async (tx) => {
    ...
    // 🕵️‍♂️ NUEVO: Registramos el movimiento en el historial automáticamente
...
window.navegarSPA = function(idDestino) {
  ...
  if (idDestino === 'vista-inventario') {
      cargarInventarioSPA();
      cargarHistorialMovimientosSPA(); // Cargamos el historial al entrar a la pestaña
  }
};
...
// ==========================================
// 💸 MÓDULO DE GASTOS Y PROVEEDORES (NUEVO)
// ==========================================
...
// ==========================================
// 🕵️‍♂️ HISTORIAL DE MOVIMIENTOS DE ALMACÉN (NUEVO)
// ==========================================
...
async function cargarHistorialMovimientosSPA() {
  ...
  } catch (e) { div.innerHTML = "<p>Error al cargar movimientos</p>"; }
}
