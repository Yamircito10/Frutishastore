...
// === Inicializadores SPA ===
// === Código movido de dashboard.html ===
function initDashboard() {
// Lógica original de inicio movida a initDashboard()
}
...
// ✅ Verificar login
  ...
  // Mostrar botón “Inventario” solo a admin
  if (rol === "admin") {
...
// === Código movido de login.html ===
function initLogin() {
const usuarios = [
    { usuario: 'admin', contrasena: '100922', rol: 'admin' },
    { usuario: 'trabajador', contrasena: '1234', rol: 'trabajador' }
  ];
...
// === Código movido de reporte-tallas.html ===
function initReportetallas() {
// Requiere sesión
  const usuario = localStorage.getItem("usuarioActivo");
