...
async function borrarHistorial() {
  ...
  try {
    ...
    if (window.toast) toast("🗑 Historial eliminado.","success"); else alert("🗑 Historial eliminado.");
  } catch (err) {
    console.error("Error eliminando historial:", err);
    if (window.toast) toast("⚠️ No se pudo borrar el historial.","error"); else alert("⚠️ No se pudo borrar el historial.");
  }
}
