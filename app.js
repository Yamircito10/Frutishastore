...
function generarPDFRecibo(productos, totalVenta, metodoPago) {
  ...
  // =========================================================================
  // 📷 CÓDIGO QR (CON SEGURO ANTI-ERRORES)
  // =========================================================================
  // Este Base64 genera un cuadradito negro. Si lo ves, el código está perfecto.
  ...
  try {
    // Lo subimos un poco (finalY + 38) y lo hicimos de 25x25 para que no se caiga
    doc.addImage(miCodigoQR, 'JPEG', 61.5, finalY + 38, 25, 25); 
  } catch (error) {
    console.error("El fantasma del QR:", error);
    notificar("⚠️ Error al dibujar el QR en el PDF", "advertencia");
  }
