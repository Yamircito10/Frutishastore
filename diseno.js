...
async function guardarDiseno() {
  ...
  try {
      ...
      await db.collection("configuracion").doc("tienda").set({
          titulo: nuevoTitulo, colorPrincipal: nuevoColor, colorWhatsApp: nuevoWa, tipografia: nuevaFuente,
          mensajeAnuncio: nuevoAnuncio, estiloTarjetas: nuevoEstilo, layoutCatalogo: nuevoLayout,
